...
[[logging.packages]]
name = "fr.company.disf.fwmc"
level = "WARN"

[[logging.packages]]
name = "fr.company.disf.assemblage"
level = "DEBUG"
```
...
**Format attendu:**
```
[INFO][fr.company.disf.assemblage] Starting ApplicationStarter...
[DEBUG][fr.company.disf.assemblage] Loaded configuration from...
[WARN][fr.company.disf.fwmc] Configuration warning...
```
...
log4j.logger.fr.company.disf.fwmc=WARN
log4j.logger.fr.company.disf.assemblage=DEBUG
```
...
3. **Report #8:** Debug logs révèlent le root cause:
   ...
   ... (application starts)
   log4j: Parsing for [fr.company.disf.fwmc] with value=[INFO, CONSOLE]  ← RE-CONFIG ❌
...
[LazyMVN Agent] ✓ Log4j successfully reconfigured with LazyMVN config
[INFO][fr.company.disf.assemblage] Starting ApplicationStarter...
[DEBUG][fr.company.disf.assemblage] Loaded configuration...
[WARN][fr.company.disf.fwmc] Configuration warning...
```
...
- ✅ Niveau WARN pour `fr.company.disf.fwmc`
- ✅ Niveau DEBUG pour `fr.company.disf.assemblage`
